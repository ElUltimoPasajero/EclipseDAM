...
public class PlantaLechera {
	...
	int num_tanques_act = 5; // N�mero de tanques actual

	public PlantaLechera(int max_tanques, int num_tanques, int[] capacidades) {
		tanques = new Tanque[max_tanques];
		// Creaci�n e inicializaci�n de los tanques
		for (int i = 0; i < num_tanques_act; i++)
	...
	public void comprar(int litros) {
		...
		while (!terminado && num_tanque < num_tanques_act) {
			try {
