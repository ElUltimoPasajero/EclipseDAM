...
public class Empleado {
	private String dni, nombre, apellidos, domicilio, codigoPostal,ciudad;
	...
	public String toString() {
		return "Empleado [dni=" + dni + ", nombre=" + nombre + ", apellidos=" + apellidos + ", domicilio=" + domicilio
				+ ", codigoPostal=" + codigoPostal + ", ciudad=" + ciudad + ", puesto=" + puesto + "]";
	}
	
	public void getAtributos() {
		System.out.println("Empleado [dni=" + dni + ", nombre=" + nombre + ", apellidos=" + apellidos + ", domicilio=" + domicilio
				+ ", codigoPostal=" + codigoPostal + ", ciudad=" + ciudad + ", puesto=" + puesto.getDescripcion() + "]");
	}
